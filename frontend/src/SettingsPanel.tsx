  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mt-6 mb-8">
      <div className="bg-gray-50 border-b p-4 flex justify-between items-center">
        ...
        <button onClick={onClose} aria-label="閉じる" className="text-gray-500 hover:text-gray-800 font-bold text-xl focus-visible:ring-2 focus-visible:ring-blue-400 rounded px-1">&times;</button>
      </div>
      ...
      <div className="p-6 space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
            <div className="border p-4 rounded-lg bg-green-50 border-green-200">
               ...
               <button aria-label="LINEアカウントと連携する" className="w-full bg-[#06C755] text-white font-bold py-2 rounded shadow hover:bg-green-600 transition-colors text-sm mt-2 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-green-500">
                 LINEアカウントと連携する
               </button>
            </div>
        ...
        <div className="flex justify-end pt-4 border-t">
          <button onClick={onClose} aria-label="設定を保存して戻る" className="bg-blue-600 text-white px-6 py-2 rounded-lg font-bold shadow hover:bg-blue-700 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-600">
            設定を保存して戻る
          </button>
        </div>
      </div>
