  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mt-6 mb-8">
      <div className="bg-gray-50 border-b p-4 flex justify-between items-center">
        ...
        <button onClick={onClose} aria-label="設定画面を閉じる" className="text-gray-500 hover:text-gray-800 font-bold text-xl">&times;</button>
      </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
            <div className="border p-4 rounded-lg bg-green-50 border-green-200">
               ...
               <label htmlFor="line-notification" className="flex items-center space-x-2 text-sm text-gray-700 mb-2 cursor-pointer">
                 <input id="line-notification" type="checkbox" defaultChecked={true} className="rounded text-green-600 focus:ring-green-500" />
            ...
            <div className="border p-4 rounded-lg bg-gray-50">
               ...
               <label htmlFor="email-notification" className="flex items-center space-x-2 text-sm text-gray-700 mb-2 cursor-pointer">
                 <input id="email-notification" type="checkbox" defaultChecked={false} className="rounded text-blue-600 focus:ring-blue-500" />
                 <span>メールで通知を受け取る</span>
               </label>
               <label htmlFor="email-address" className="sr-only">メールアドレス</label>
               <input id="email-address" type="email" placeholder="example@hotel.com" className="w-full p-2 border rounded text-sm focus:ring-2 focus:ring-blue-400 outline-none mt-1" />
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               <div>
                 ...
                 <select id="price-threshold" defaultValue="3000" className="w-full p-2 border rounded text-sm focus:ring-2 focus:ring-blue-400 outline-none bg-white">
               ...
               <div>
                 ...
                 <select id="notification-timing" defaultValue="morning" className="w-full p-2 border rounded text-sm focus:ring-2 focus:ring-blue-400 outline-none bg-white">
