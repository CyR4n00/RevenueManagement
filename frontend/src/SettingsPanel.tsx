          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
            <div className="border p-4 rounded-lg bg-green-50 border-green-200">
               ...
               <label htmlFor="line-notify" className="flex items-center space-x-2 text-sm text-gray-700 mb-2 cursor-pointer">
                 <input id="line-notify" type="checkbox" defaultChecked={true} className="rounded text-green-600 focus-visible:ring-2 focus-visible:ring-green-500 outline-none cursor-pointer" />
            ...
            <div className="border p-4 rounded-lg bg-gray-50">
               ...
               <label htmlFor="email-notify" className="flex items-center space-x-2 text-sm text-gray-700 mb-2 cursor-pointer">
                 <input id="email-notify" type="checkbox" defaultChecked={false} className="rounded text-blue-600 focus-visible:ring-2 focus-visible:ring-blue-500 outline-none cursor-pointer" />
                 <span>メールで通知を受け取る</span>
               </label>
               <input aria-label="メールアドレス" type="email" placeholder="example@hotel.com" className="w-full p-2 border rounded text-sm focus-visible:ring-2 focus-visible:ring-blue-400 outline-none mt-1" />
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               <div>
                 ...
                 <select id="alert-threshold" defaultValue="3000" className="w-full p-2 border rounded text-sm focus-visible:ring-2 focus-visible:ring-blue-400 outline-none bg-white">
               ...
               <div>
                 ...
                 <select id="alert-timing" defaultValue="morning" className="w-full p-2 border rounded text-sm focus-visible:ring-2 focus-visible:ring-blue-400 outline-none bg-white">
