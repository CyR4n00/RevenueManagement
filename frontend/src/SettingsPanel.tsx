  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mt-6 mb-8">
      <div className="bg-gray-50 border-b p-4 flex justify-between items-center">
        ...
        <button onClick={onClose} aria-label="設定を閉じる" className="text-gray-500 hover:text-gray-800 font-bold text-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 rounded">&times;</button>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
            <div className="border p-4 rounded-lg bg-green-50 border-green-200">
               ...
               <div className="flex items-center space-x-2 mb-2">
                 ...
                 <label htmlFor="line-notify" className="text-sm text-gray-700">LINEで通知を受け取る</label>
               </div>
            ...
            <div className="border p-4 rounded-lg bg-gray-50">
               ...
               <div className="flex items-center space-x-2 mb-2">
                 ...
                 <label htmlFor="email-notify" className="text-sm text-gray-700">メールで通知を受け取る</label>
               </div>
               <label htmlFor="email-address" className="sr-only">メールアドレス</label>
               <input id="email-address" type="email" placeholder="example@hotel.com" className="w-full p-2 border rounded text-sm focus-visible:ring-2 focus-visible:ring-blue-400 outline-none mt-1" />
            </div>
          </div>
