  ...
  return (
    <div id="settings-panel" className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mt-6 mb-8">
      <div className="bg-gray-50 border-b p-4 flex justify-between items-center">
        ...
        <button onClick={onClose} aria-label="設定を閉じる" className="text-gray-500 hover:text-gray-800 font-bold text-xl focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none focus-visible:rounded">&times;</button>
      </div>
      ...
      <div className="p-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
            <div className="border p-4 rounded-lg bg-green-50 border-green-200">
               ...
               <label htmlFor="line-notify" className="flex items-center space-x-2 text-sm text-gray-700 mb-2 cursor-pointer">
                 <input id="line-notify" type="checkbox" defaultChecked={true} className="rounded text-green-600 focus-visible:ring-2 focus-visible:ring-green-500" />
            ...
            <div className="border p-4 rounded-lg bg-gray-50">
               ...
               <label htmlFor="email-notify" className="flex items-center space-x-2 text-sm text-gray-700 mb-2 cursor-pointer">
                 <input id="email-notify" type="checkbox" defaultChecked={false} className="rounded text-blue-600 focus-visible:ring-2 focus-visible:ring-blue-500" />
                 <span>メールで通知を受け取る</span>
               </label>
               <label htmlFor="email-input" className="sr-only">メールアドレス</label>
               <input id="email-input" type="email" placeholder="example@hotel.com" className="w-full p-2 border rounded text-sm focus-visible:ring-2 focus-visible:ring-blue-400 outline-none mt-1" />
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               <div>
                 ...
                 <select id="notify-threshold" defaultValue="3000" className="w-full p-2 border rounded text-sm focus-visible:ring-2 focus-visible:ring-blue-400 outline-none bg-white">
               ...
               <div>
                 ...
                 <select id="notify-timing" defaultValue="morning" className="w-full p-2 border rounded text-sm focus-visible:ring-2 focus-visible:ring-blue-400 outline-none bg-white">
        ...
        <div className="flex justify-end pt-4 border-t">
          <button onClick={onClose} className="bg-blue-600 text-white px-6 py-2 rounded-lg font-bold shadow hover:bg-blue-700 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-600 focus-visible:outline-none">
            設定を保存して戻る
          </button>
        </div>
      </div>
