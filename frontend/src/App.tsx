        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 bg-white p-4 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="flex space-x-3 items-center">
            ...
            <button
               ...
               className={`text-sm font-bold border px-3 py-2 rounded transition-colors focus-visible:ring-2 focus-visible:ring-gray-800 outline-none ${showSettings ? 'bg-gray-800 text-white border-gray-800' : 'text-gray-600 hover:bg-gray-50'}`}
             >
               ⚙️ ベンチマーク設定
            </button>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-1 bg-gradient-to-br from-indigo-500 to-blue-600 rounded-xl shadow-md p-5 text-white flex flex-col justify-between">
                ...
                <button className="mt-6 w-full bg-white text-blue-700 font-bold py-2 rounded shadow hover:bg-blue-50 transition-colors text-sm focus-visible:ring-2 focus-visible:ring-white outline-none">
                  ✓ この価格を自社システムに反映する
                </button>
              </div>
