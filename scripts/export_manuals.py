...
def build_client_visual():
    ...
    visual_screen_page(canvas, "競合の価格を比べる", "STEP 4", "dashboard-comparison.png", [
        "左側に、登録した競合施設が並びます。宿の名前は固定されています。",
        "表を横へ動かすと、宿の名前を見ながら別の日付も比べられます。",
        "赤は値上げ、青は値下げです。",
    ...
    visual_screen_page(canvas, "毎日の確認は3分で終わります", "STEP 8", "dashboard-overview.png", [
        "情報は、ログアウト中も午前9時と午後6時ごろに自動取得します。",
        "確認したい日にログインし、まず競合平均価格を見ます。",
        "次に、参考ランクと部屋なし件数を見ます。",
        "気になる日はカレンダーから選びます。",
        "理由を読んで、実際の販売価格を決めます。",
    ], [(0.90, 0.14, 0.80, 0.10), (0.35, 0.34, 0.42, 0.25), (0.75, 0.35, 0.78, 0.24), (0.14, 0.30, 0.21, 0.37), (0.38, 0.72, 0.47, 0.64)], "情報を取るために、毎日ログインしておく必要はありません。")
